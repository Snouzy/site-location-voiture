...
<head>
    ...
    <!--=== Menu personal CSS ===-->
    <link href="assets/css/admin-menu.css" rel="stylesheet">
    <!--=== Bootstrap CSS ===-->
    ...
    <div class="wrapper">
        ...
        <nav id="sidebar">
            <div class="sidebar-header">
                <h3 id="sidebar--title">Administration</h3>
            </div>

            <ul class="list-unstyled components">
                <p>ALSACAR</p>
                <li class="active">
                    <a href="#homeSubmenu" data-toggle="collapse" aria-expanded="false" class="dropdown-toggle">Voitures</a>
                    <ul class="collapse list-unstyled" id="homeSubmenu">
                        <li>
                            <a href="?page=voitures-admin">Voir toutes les voitures</a>
                        </li>
                        <li>
            ...
            <form method="POST" action="">
                <ul class="list-unstyled CTAs">
                    <li>
                        <a href="?page=accueil" class="voirLeSite">Voir le site</a>
                    </li>
                    <li>
                        <input type="submit" value="Déconnexion"></input>
                    </li>
                </ul>
                <input type="hidden" name="deconnexion" value="true" id="deconnexion"/>
            </form>
        </nav>
        <!--== Sidebar Area End   ==-->
